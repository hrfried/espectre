...
**What it does:** Removes statistical outliers from turbulence values using MAD (Median Absolute Deviation). This helps reduce false positives caused by sudden interference.
...
```yaml
espectre:
  hampel_enabled: true     # Enable/disable
...
|-----------|---------|-------|-------------|
| `hampel_enabled` | true | - | Enable/disable Hampel filter |
...
**When to adjust:**
- High interference (fans, AC) → lower threshold (2.0-3.0)
- Missing subtle movements → higher threshold (5.0-6.0) or disable
